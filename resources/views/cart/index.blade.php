...
@section('container')
    <div class="w-full h-max bg-white p-4 rounded-lg">
        ...
        <form action="/note" method="post" class="flex flex-col gap-3">
            ...
            @endphp
            <input type="text" placeholder="Nama Pembeli" name="nama" class="border px-1 py-2 rounded-lg shadow-md">
                    ...
                    <div class="lg:w-full">
                        ...
                        <div class="flex flex-col gap-2 mt-2">
                            ...
                            <input type="number" name="jumlah_barang[]"
                                id="jumlah_barang_{{ $index }}" placeholder="Jumlah Barang" min="1"
            ...
            <button
                class="bg-green-600 w-full text-white mt-4 px-3 py-2 rounded-lg hover:bg-green-500 hover:duration-150 lg:w-max lg:px-8">Simpan</button>
        </form>
    </div>
    <script>
